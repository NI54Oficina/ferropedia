...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<input id="RelPartidoJugador_jugador2" class="form-control" type="text" placeholder="" <?php if(isset($model->jugador)){ ?> disabled value="<?php 
	...
	<div class="row">
		...
		<input id="RelPartidoJugador_partido2" class="form-control" disabled type="text" placeholder="<?php if(isset($model->partido)){
	...
	<div class="row">
		...
		<select name="RelPartidoJugador[campo]" id="RelPartidoJugador_campo" class="form-control">

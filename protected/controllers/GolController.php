...
class GolController extends Controller
{
	...
	public function actionView($id)
	{
		$this->render('view',array(
			'model'=>Gol::model()->with(array("jugador_data","partido_data"))->findByPk($id),
		));
	}
	...
	{
		$dataProvider=new CActiveDataProvider('Gol');
	...
	{
		$model=new Gol('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Gol']))
			$model->attributes=$_GET['Gol'];
	 ...
	 * @param Gol $model the model to be validated
	 */
